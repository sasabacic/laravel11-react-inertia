    ...
    return (
        <AuthenticatedLayout
            header={
                ...
                <Link href={route('project.create')} className="bg-emerald-400 py-1 px-3 text-white rounded
                            ...
                            >
                                ...
                                >
                                    <tr className="text-nowrap">
                                        ...
                                        <th className="px-3 py-3 text-right">Created By</th>
                                    ...
                                    dark:border-gray-700" key={project.id}
                                        >
                                            ...
                                            <td className="px-3 py-2 text-nowrap">
                                                ...
                                                dark:text-red-500 hover:undeline mx-1">
                                                    Delete
                                                </button>
                                            </td>
                                        </tr>
